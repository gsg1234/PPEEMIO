...
Q1 = np.array([-np.pi/4, 146.62])  # Exemple de configuration pour le robot EMIO
Q3 = np.array([-np.pi/4, 146.62])
...
# print(f"Angles S1: {calculer_GI2(p.S1[0], p.S1[1])}")
# print(f"Angles S2: {calculer_GI2(p.S2[0], p.S2[1])}")
# print(f"Angles S3: {calculer_GI2(p.S3[0], p.S3[1])}")
# print(f"Angles S4: {calculer_GI2(p.S4[0], p.S4[1])}")