...
ax.plot(-p.L+p.r_eq_max*np.cos(theta_c), p.r_eq_max*np.sin(theta_c), color=[1, 0, 1], linewidth=0.5)
ax.plot(-p.L+p.r_eq_min*np.cos(theta_c), p.r_eq_min*np.sin(theta_c), color=[0, 1, 0], linewidth=0.5)
